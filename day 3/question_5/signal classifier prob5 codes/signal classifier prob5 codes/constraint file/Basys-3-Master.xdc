    ...
    set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[0]}]
    set_property -dict {PACKAGE_PIN W17 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[1]}]
    set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[2]}]
    set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[3]}]
    set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[4]}]
    set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[5]}]
    set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[6]}]
    set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports {seq_len_sw[7]}]
    ...
    ##7 Segment Display
    set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports done]
    ...
    create_pblock pblock_symmetry_rp
    add_cells_to_pblock [get_pblocks pblock_symmetry_rp] [get_cells -quiet [list u_RP]]
    resize_pblock [get_pblocks pblock_symmetry_rp] -add {SLICE_X6Y113:SLICE_X27Y145}
    resize_pblock [get_pblocks pblock_symmetry_rp] -add {DSP48_X0Y46:DSP48_X0Y57}
    resize_pblock [get_pblocks pblock_symmetry_rp] -add {RAMB18_X0Y46:RAMB18_X0Y57}
    resize_pblock [get_pblocks pblock_symmetry_rp] -add {RAMB36_X0Y23:RAMB36_X0Y28}
    
    set_property RESET_AFTER_RECONFIG false [get_pblocks pblock_symmetry_rp]
